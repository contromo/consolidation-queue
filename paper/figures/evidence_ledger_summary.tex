...
PFLC to test whether the governable evidence handle is exposed. Stage~3
preserves the LongMemEval v1 loss and then uses a paired repair and control to
pin that loss on answer-time readout cardinality. The figure preserves the
claim numbering but frames the contribution as an attribution method.}
