...
\node[s3, right=18mm of stage2] (stage3) {
  \begin{tabular}{@{}c@{}}
    ...
    {\scriptsize LongMemEval loss}\\[-2pt]
...
preserves the LongMemEval loss and then uses a paired repair/control to isolate
answer-time readout cardinality. The figure preserves the claim numbering but
