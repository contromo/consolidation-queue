...
%
% Usage in main.tex: requires TikZ with positioning, fit, backgrounds,
% arrows.meta, and calc.
% Replace the existing \includegraphics{figures/externalization_protocol.png}
...
\node[policy, below right=4mm and 10mm of adapter, anchor=west] (mem0) {ADD/UPDATE/NOOP};

\node[score, right=24mm of refl] (scorer) {PFLC scorer\\and verdict};
