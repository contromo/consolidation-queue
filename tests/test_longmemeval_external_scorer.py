...
class LongMemEvalScorerTests(unittest.TestCase):
    ...
    def test_missing_gold_case_is_dropped_and_recorded(self) -> None:
        ...
        result = score_predictions(predictions, gold)
        self.assertEqual(result["summary"]["missing_gold_case_count"], 1)
        self.assertIn("c-missing", result["summary"]["missing_gold_case_ids"])
