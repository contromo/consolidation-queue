...
- reran `scripts/run_component_scoring_matrix.py` once with script defaults and no `--force`
...
- descriptive row observations:
  ...
  - 32B headroom rows reported no scenario errors and no measured artifact gate failures
