...
- locked CQR audit preregistration, runner, and tests, plus
  `docs/canonical_id_resolution_audit_results.md` recording the 2026-05-15
  Bucket D abort on locked replay
